...
from dytgateformer import DytGateFormer
...
class DytGateFormerImageClassification(DytGateFormer):
    def __init__(
        self,
        image_size=32,
        patch_size=4,
        ...
        super().__init__(d_model, heads,num_layers)
...
model = DytGateFormerImageClassification().to(device)
print(model)
